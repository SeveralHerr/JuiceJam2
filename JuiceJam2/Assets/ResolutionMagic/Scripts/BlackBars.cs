...
public class BlackBars : MonoBehaviour
{
    ...
    {
        Debug.Log(ResolutionManager.Instance.CanvasBoundary.Centre);
        Vector2 adjustment = (Vector2)Camera.main.transform.position - ResolutionManager.Instance.CanvasBoundary.Centre;
        switch (alignment)
        {
